...
export default async function PricingPage() {
  ...
  return (
    <section className="mx-auto w-full max-w-7xl flex-1 px-6 py-12">
      <h1 className="mb-10 text-center text-4xl font-semibold after:mx-auto after:mt-3 after:block after:h-1 after:w-14 after:rounded-full after:bg-linear-to-r after:from-[#e8a7c8] after:to-[#9a6ab2]">
        Catalog
      </h1>
              ...
              {prices
                ...
                .map((item) => (
                  ...
                  >
                    ...
                    <strong className="shrink-0 rounded-xl bg-[#34232f] px-3 py-1.5 text-sm font-medium text-white transition hover:scale-105 hover:bg-[#80506f]">
                      {item.price}
                    </strong>
                  </li>
                ))}
